      ...
      <div className="flex">
        ...
        <div className="col2 column flex flex-align-end">
          <p>
            ...
            . I was using React.js in front and Node.js/Express.js in back, also
            I used MySQL database.
            <br />
            <br /> I have been creating websites for six years, trying to learn
            newer and newer technologies but always I remember the fact that
            every based on JavaScript.
            <br />
            ...
            <br />
            <br /> In my spare time I play volleyball and I like spending time
            in the <span onClick={handleSpanClick}>Tatra Mountains</span>, doing
            all available activities such as climbing, hiking, skiing.
          </p>
        </div>
      </div>
    </Container>
